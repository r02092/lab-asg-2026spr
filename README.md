...
- 検出するARマーカーによってURLが異なる
  - [土佐山田駅の駅名標](https://r02092.github.io/lab-asg-2026spr/#tosayamada)
  - [土佐日記御崎の泊碑](https://r02092.github.io/lab-asg-2026spr/#tosanikki)
  - [飲食禁止を示すピクトグラム](https://r02092.github.io/lab-asg-2026spr/#insyoku)
- 使用しているAPIの都合上、Android上のGoogle Chrome以外では一部の機能が正常に動作しない
